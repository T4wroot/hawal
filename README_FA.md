...
4. **GOST v3** جایگزین Raw Packet Paqet نیست؛ به‌عنوان مسیر پشتیبان پایدار، با TLS پیش‌فرض یا WebSocket/KCP/QUIC استفاده کنید. GOST در Hawal هر mapping را برای TCP و UDP ایجاد می‌کند؛ بنابراین QUIC و Hysteria2 نیز پشتیبانی می‌شوند.
